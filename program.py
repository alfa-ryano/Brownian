...
class MainProgram:
    ...
    def start(self):
        ...
        if form_conf[self.CONF_FORM_TYPE] == RegisterForm.__name__:
            self.current_form = RegisterForm(self)
        elif form_conf[self.CONF_FORM_TYPE] == SimulationForm.__name__:
            self.current_form = SimulationForm(self, form_conf[self.CONF_FORM_TITLE],
                                               form_conf[self.CONF_FORM_INSTRUCTION], form_conf[self.CONF_FORM_DIALOG])
